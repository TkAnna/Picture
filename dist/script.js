...
/***/ "./src/js/modules/collapseBlock.js":
/*!*****************************************!*\
  !*** ./src/js/modules/collapseBlock.js ***!
  \*****************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
const collapseBlock = triggersSelector => {
...
/* harmony default export */ __webpack_exports__["default"] = (collapseBlock);
  ...
  const showItems = () => {
    items.forEach(item => {
      item.addEventListener('click', () => {
        let aktiveClass = item.classList[0];
        let markType = wrapper.querySelectorAll(`.${aktiveClass}`);
        typeFilter(markType);
      });
    });
  };
...
/* harmony import */ var _validateEmail__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./validateEmail */ "./src/js/modules/validateEmail.js");
...
const forms = state => {
  ...
  form.forEach(item => {
    ...
    item.addEventListener('submit', e => {
      ...
      let noError = (0,_validateEmail__WEBPACK_IMPORTED_MODULE_1__["default"])(email.value);
...
const scrolling = upSelector => {
  ...
  ////////// Scrolling width window.requestAnimationFrame()
  ...
  function activateAnimation() {
    if (dir === 'vertical') {
      paused = setInterval(function () {
        plusSlides(1);
        items[slideIndex - 1].classList.add('zoomIn', 'animate__delay-5s', 'animate__slower');
      }, 5000);
    } else {
      paused = setInterval(function () {
        plusSlides(1);
...
/* harmony import */ var _modules_collapseBlock__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/collapseBlock */ "./src/js/modules/collapseBlock.js");
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_collapseBlock__WEBPACK_IMPORTED_MODULE_9__["default"])('.accordion-heading');
